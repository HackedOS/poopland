use crate::{grabs::resize_grab, PoopLand};
use smithay::{
...
impl CompositorHandler for PoopLand {
...
impl BufferHandler for PoopLand {
    fn buffer_destroyed(&mut self, _buffer: &wl_buffer::WlBuffer) {}
}

impl ShmHandler for PoopLand {
    fn shm_state(&self) -> &ShmState {
        &self.shm_state
    }
}

delegate_compositor!(PoopLand);
delegate_shm!(PoopLand);
